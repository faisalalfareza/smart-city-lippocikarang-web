...
window.webcam = {
	...
	swf_url: 'http://localhost/smartcity/user/cam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://localhost/assets/front/js/shutter.mp3', // URI to shutter.mp3 sound
